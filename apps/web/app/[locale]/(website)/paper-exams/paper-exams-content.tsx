      ...
      <section className="py-16 md:py-24 bg-muted/50 relative">
        ...
        <div className="container px-4 md:px-6 relative z-10">
          ...
          <div className="grid gap-8 lg:grid-cols-2 items-center mt-12">
            ...
            <ScrollAnimation delay={100} className="flex justify-center h-full">
            ...
            <ScrollAnimation delay={200} className="h-full">
              <div className="bg-card backdrop-blur-sm rounded-xl border border-primary/20 p-8 shadow-lg card-hover h-full flex flex-col justify-center">
          ...
          <div className="grid gap-8 lg:grid-cols-2 mt-12">
            ...
            <ScrollAnimation delay={400} className="h-full">
              <div className="bg-card backdrop-blur-sm rounded-xl border border-secondary/20 p-8 shadow-lg card-hover h-full flex flex-col justify-center">
        ...
        <div className="container px-4 md:px-6">
          ...
          <div className="grid gap-8 lg:grid-cols-2 items-center mt-12">
            ...
            <ScrollAnimation delay={200}>
              <div className="bg-card backdrop-blur-sm rounded-xl border border-primary/20 p-8 shadow-lg space-y-8 card-hover">
                <h3 className="text-2xl font-bold text-primary mb-6">
